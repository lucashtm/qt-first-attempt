#############################################################################
# Makefile for building: QTuner
# Generated by qmake (3.1) (Qt 5.11.2)
# Project:  QTuner.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile QTuner.pro
#############################################################################
...
INCPATH       = -I. -isystem /usr/include/qt -isystem /usr/include/qt/QtWidgets -isystem /usr/include/qt/QtMultimedia -isystem /usr/include/qt/QtGui -isystem /usr/include/qt/QtNetwork -isystem /usr/include/qt/QtCore -I. -isystem /usr/include/libdrm -I. -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = QTuner1.0.0
DISTDIR = /home/lucasmonteiro/kde/QTuner/.tmp/QTuner1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now
LIBS          = $(SUBLIBS) /usr/local/lib/libfftw3.a -lQt5Widgets -lQt5Multimedia -lQt5Gui -lQt5Network -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
$(TARGET): ui_qtuner.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: QTuner.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents qtuner.h AudioFile.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp qtuner.cpp AudioFile.cpp $(DISTDIR)/
	$(COPY_FILE) --parents qtuner.ui $(DISTDIR)/
...
compiler_moc_header_make_all: moc_qtuner.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_qtuner.cpp
moc_qtuner.cpp: qtuner.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/lucasmonteiro/kde/QTuner/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/lucasmonteiro/kde/QTuner -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtMultimedia -I/usr/include/qt/QtGui -I/usr/include/qt/QtNetwork -I/usr/include/qt/QtCore -I/usr/include/c++/8.2.1 -I/usr/include/c++/8.2.1/x86_64-pc-linux-gnu -I/usr/include/c++/8.2.1/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/8.2.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/8.2.1/include-fixed -I/usr/include qtuner.h -o moc_qtuner.cpp

compiler_moc_objc_header_make_all:
compiler_moc_objc_header_clean:
compiler_moc_source_make_all:
compiler_moc_source_clean:
compiler_uic_make_all: ui_qtuner.h
compiler_uic_clean:
	-$(DEL_FILE) ui_qtuner.h
ui_qtuner.h: qtuner.ui \
		/usr/bin/uic
	/usr/bin/uic qtuner.ui -o ui_qtuner.h
...
main.o: main.cpp qtuner.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

qtuner.o: qtuner.cpp qtuner.h \
		ui_qtuner.h \
		AudioFile.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qtuner.o qtuner.cpp

AudioFile.o: AudioFile.cpp AudioFile.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o AudioFile.o AudioFile.cpp

moc_qtuner.o: moc_qtuner.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_qtuner.o moc_qtuner.cpp

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/QTuner/bin || mkdir -p $(INSTALL_ROOT)/opt/QTuner/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/QTuner/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/QTuner/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/QTuner/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/QTuner/bin/ 
